...
# Aqui esta el codigo en geant4 de la simulacion del cristal
Este codigo es el que me pasaste modificado, los archivos de analysis en python estan en la carpeta analysis, ahi estan todos los .py que utilize para generar las graficas. En muchos aun faltan cambiar las funciones SPE, dark noise y afterpulses, esto ire cambiando segun lo necesitemos.
